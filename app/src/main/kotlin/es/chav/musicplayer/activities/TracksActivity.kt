...
import es.chav.musicplayer.adapters.TracksAdapter.Companion.TYPE_ALBUM
import es.chav.musicplayer.adapters.TracksAdapter.Companion.TYPE_FOLDER
import es.chav.musicplayer.adapters.TracksAdapter.Companion.TYPE_PLAYLIST
import es.chav.musicplayer.adapters.TracksAdapter.Companion.TYPE_TRACKS
import es.chav.musicplayer.adapters.TracksHeaderAdapter
import es.chav.musicplayer.databinding.ActivityTracksBinding
import es.chav.musicplayer.dialogs.ChangeSortingDialog
import es.chav.musicplayer.dialogs.ExportPlaylistDialog
import es.chav.musicplayer.extensions.audioHelper
import es.chav.musicplayer.extensions.config
import es.chav.musicplayer.extensions.getFolderTracks
import es.chav.musicplayer.extensions.getMediaStoreIdFromPath
import es.chav.musicplayer.helpers.*
import es.chav.musicplayer.helpers.M3uExporter.ExportResult
