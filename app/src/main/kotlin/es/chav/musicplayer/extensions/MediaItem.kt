...
import es.chav.musicplayer.helpers.EXTRA_ALBUM
import es.chav.musicplayer.helpers.EXTRA_ALBUM_ID
import es.chav.musicplayer.helpers.EXTRA_ARTIST
import es.chav.musicplayer.helpers.EXTRA_ARTIST_ID
import es.chav.musicplayer.helpers.EXTRA_COVER_ART
import es.chav.musicplayer.helpers.EXTRA_DATE_ADDED
import es.chav.musicplayer.helpers.EXTRA_DURATION
import es.chav.musicplayer.helpers.EXTRA_FLAGS
import es.chav.musicplayer.helpers.EXTRA_FOLDER_NAME
import es.chav.musicplayer.helpers.EXTRA_GENRE
import es.chav.musicplayer.helpers.EXTRA_GENRE_ID
import es.chav.musicplayer.helpers.EXTRA_ID
import es.chav.musicplayer.helpers.EXTRA_MEDIA_STORE_ID
import es.chav.musicplayer.helpers.EXTRA_ORDER_IN_PLAYLIST
import es.chav.musicplayer.helpers.EXTRA_PATH
import es.chav.musicplayer.helpers.EXTRA_PLAYLIST_ID
import es.chav.musicplayer.helpers.EXTRA_TITLE
import es.chav.musicplayer.helpers.EXTRA_TRACK_ID
import es.chav.musicplayer.helpers.EXTRA_YEAR
import es.chav.musicplayer.inlines.indexOfFirstOrNull
